import{dB as x,dY as ae,cM as c,cO as de,cx as C,cy as L,cB as w,cC as y,cD as d,cA as l,d2 as W,cX as _,dc as u,cz as ue,cF as D,cT as g,da as j,dU as he,dH as V,cQ as U,dk as E,c$ as F,cI as pe,cN as O,dD as z,dR as ee,db as me,cH as ne,dZ as fe,d_ as we}from"./index-Be53bwIm.js";import"./index-DeG-aLHj.js";import{S as be}from"./SwapController-riPLdl_Q.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
